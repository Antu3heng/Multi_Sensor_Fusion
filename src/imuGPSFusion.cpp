 ...
 * @param n_bw 
 */
imuGPSFusion::imuGPSFusion(Vector3d gravity, double n_a, double n_w, double n_ba, double n_bw) : isInitialized_(false), 
                            gravity_(gravity), n_a_(n_a), n_w_(n_w), n_ba_(n_ba), n_bw_(n_bw)
{
    state_.pos_.setZero();
    state_.vel_.setZero();
    state_.q_.setIdentity();
